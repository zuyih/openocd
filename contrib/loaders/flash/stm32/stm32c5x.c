...
/*
 * STM32C5x flash loader, derived from the STM32H5x one.
 */

#define OPENOCD_CONTRIB_LOADERS_FLASH_STM32_STM32C5X

#include <stdint.h>
#include "../../../../src/flash/nor/stm32c5x.h"
...
void write(volatile struct stm32c5x_work_area *work_area,
		   uint8_t *fifo_end,
